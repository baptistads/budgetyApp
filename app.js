...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      // 2 Calculate de budget: income - expenses
    ...
    calculatePercentages: function() {
      data.allItems.exp.forEach(function(cur) {
        // Method Prototype - receive one integer
        cur.calcPercentage(data.totals.inc);
      });
    },

    getPercentages: function() {
      // new array with all percentages of all exp elements
...
var controller = (function(budgetCtr, UICtrl) {
  ...
  var ctrlDeleteItem = function(event) {
    ...
    if (itemID) {
      // Array with type and ID of target item
